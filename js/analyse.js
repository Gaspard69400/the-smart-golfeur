...
function renderPutting() {
  ...
  // Détail putting + sauvetages (puttingstats.js, S42)
  ptsRender(page, rounds);
}
...
function renderEvolution() {
  ...
  // (round.putts est un TOTAL : l'ancienne version le lisait comme un tableau et ne trouvait jamais rien)
  var puttsByRound = chrono.map(function(r) {
    ...
    return (typeof r.putts === 'number' && r.putts >= 18 && filled >= 18) ? r.putts : null;
